...
namespace DataModel.ResponseMessage
{
    public class MessageCodes
    {
        ...
        public static string CreateAccountSuccessfully = "MESSAGE.create_account_successfully";

        public static string CreateUploadSuccessfully = "MESSAGE.create_upload_successfully";

        public static string CreateAccountFail = "MESSAGE.create_account_fail";
        ...
        public static string UsernameNotExists = "MESSAGE.username_not_exists";
